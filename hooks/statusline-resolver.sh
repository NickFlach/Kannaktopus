#!/usr/bin/env bash
# Kannaktopus Statusline Resolver — version-agnostic launcher
# ═══════════════════════════════════════════════════════════════════════════════
# Installed to ~/.kannaktopus/statusline.sh by the plugin.
...
CACHE_BASE="$HOME/.claude/plugins/cache/kannaka-plugins/octo"
