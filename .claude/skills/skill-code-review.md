...
**Your first output line MUST be:** `🐙 **KANNAKTOPUS ACTIVATED** - Multi-LLM Code Review`
...
if [[ -n "$PR_NUM" ]]; then
    ...
    REVIEW_BODY="## Code Review — Kannaktopus

${REVIEW_SYNTHESIS}

---
*Review generated by Kannaktopus (/octo:review)*
