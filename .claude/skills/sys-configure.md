...
aliases:
  - config
  - configure
description: Configure Kannaktopus providers, models, and preferences — use for initial setup or provider changes
trigger: |
  Use this skill when the user wants to "configure Kannaktopus", "setup octopus",
