...
export const SKILL_REGISTRY: SkillRegistryEntry[] = [
  ...
  { name: "sys-configure", description: "Configure Kannaktopus providers, models, and preferences — use for initial setup or provider changes", type: "skill", file: "sys-configure.md" },
  ...
  { name: "setup", description: "Check Kannaktopus setup status and get configuration instructions", type: "command", file: "setup.md" },
